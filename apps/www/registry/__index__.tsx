...
export const Index: Record<string, any> = {
  ...
  "location-map": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/gammaui/location-map.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "location-map"
      return { default: mod.default || mod[exportName] }
    }),
    meta: {},
  },
  "3d-folder": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/gammaui/3d-folder.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "3d-folder"
      return { default: mod.default || mod[exportName] }
    }),
    meta: {},
  },
  ...
  "rabbit-mascot": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/gammaui/rabbit-mascot.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "rabbit-mascot"
      return { default: mod.default || mod[exportName] }
    }),
    meta: {},
  },
  ...
  "location-map-demo": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/example/location-map-demo.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "location-map-demo"
      return { default: mod.default || mod[exportName] }
    }),
    meta: {},
  },
  ...
  "rabbit-mascot-demo": {
    ...
    component: React.lazy(async () => {
      const mod = await import("@/registry/example/rabbit-mascot-demo.tsx")
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "rabbit-mascot-demo"
      return { default: mod.default || mod[exportName] }
    }),
    meta: {},
  },
