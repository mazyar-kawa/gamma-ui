...
export const examples: Registry["items"] = [
...

  {
    ...
    description:
      "An expandable and animated support widget with quick help actions using Framer Motion.",
  ...
  },
  {
    ...
    description:
      "A looping animated gradient button using Framer Motion’s spring transitions for smooth motion effects.",
  ...
  },
  {
    ...
    description:
      "An interactive button that animates its border dynamically based on cursor position using Framer Motion.",
  ...
  },
  {
    ...
    description:
      "An example demonstrating the Wavy Block scroll-triggered animation with multiple text lines.",
