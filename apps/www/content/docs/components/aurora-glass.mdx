...
The `AuroraGlass` component renders an animated field of rounded glass tiles using a raw WebGL2 canvas.
...
- ⚡ **Raw WebGL2** — GPU-accelerated rendering with no external dependencies.
